        ...
        search_query:
          ...
          rm3:
            ...
            document_id_score_dict: (only in bm25 or rm3)
              document_id: score
    """
    search_data_filepath = os.path.join(alsim.paths.DERIVED_DATA_DIR, 'query', 'search_data_all.json')
...
def load_training_and_testing_docs():
    ...
    document_dicts_filepath = os.path.join(alsim.paths.DERIVED_DATA_DIR, 'amazon_reviews_us', 'eval_docs.pkl')
